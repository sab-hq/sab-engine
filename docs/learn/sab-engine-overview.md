...
- **Concurrency (claim/lease pattern) — not yet built (PD-5).**
...
- ✅ Solution scaffold, database schema, and a production-quality state machine with a real audit trail — further along than "minimum viable" already, not a stripped-down placeholder
